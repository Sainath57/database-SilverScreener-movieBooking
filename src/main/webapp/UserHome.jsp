...
<main>
    ...
    <div  id ="N" class="movie action">
        ...
        <div class="movie-content">
            ...
            <a href="http://localhost:8080/demo2_war_exploded/showbooking.jsp" class="book-button" onclick="bookTicket('N')">Book Ticket</a>
        </div>
    </div>
    ...
    <div id ="M" class="movie comedy">
        ...
        <div class="movie-content">
            ...
            <a href = "http://localhost:8080/demo2_war_exploded/showbooking.jsp" class="book-button" onclick="bookTicket('M')">Book Ticket</a>
        </div>
    </div>
    ...
    <div id = "W" class="movie comedy">
        ...
        <div class="movie-content">
            ...
            <p>Description of the comedy movie. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <a href="http://localhost:8080/demo2_war_exploded/showbooking.jsp" class="book-button" onclick="bookTicket('W')">Book Ticket</a>
        </div>
    </div>
    ...
    <div id = "T" class="movie comedy">
        ...
        <div class="movie-content">
            ...
            <p>Description of the comedy movie. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <a href="http://localhost:8080/demo2_war_exploded/showbooking.jsp" class="book-button" onclick="bookTicket('T')">Book Ticket</a>
        </div>
    </div>
    ...
    <div id = "H" class="movie comedy">
        ...
        <div class="movie-content">
            ...
            <p>Description of the comedy movie. Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            <a href="http://localhost:8080/demo2_war_exploded/showbooking.jsp" class="book-button" onclick="bookTicket('H')">Book Ticket</a>
        </div>
    </div>
