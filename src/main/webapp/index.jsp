...
<header>
    ...
    <button id="signInButton" onclick="location.href='http://localhost:8080/demo2_war_exploded/login.jsp';">SignIn</button>
    <button id="RegisterButton" onclick="location.href='http://localhost:8080/demo2_war_exploded/register.jsp';">Register</button>
...
<main>
    ...
    <div class="movie action">
        ...
        <div class="movie-content">
            ...
            <a href="http://localhost:8080/demo2_war_exploded/theatreSelection.jsp" class="book-button">Book Ticket</a>
        </div>
    </div>
