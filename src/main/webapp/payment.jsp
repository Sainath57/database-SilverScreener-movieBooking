<%@ page import="com.example.demo2.booking" %>
...
<div class="payment-container">
  <div class="details-container">
    <div class="left-details">
      <p>Name : <% String firstName = (String) session.getAttribute("firstName");
        out.print(firstName); %></p>
     <!-- <p>No. of Seats:<% //int seat_no = (int) session1.getAttribute("seat_no");
      //out.print(seat_no);%> </p> -->
    ...
    <div class="right-details">
      <p>Total Cost: $<%
        float totalPrice = booking.seat_no * 10;
  ...
  <div class="buttons-container">
    ...
    <button id="cancelBtn" onclick="location.href='http://localhost:8080/demo2_war_exploded/UserHome.jsp';" >Cancel</button>
  </div>
...
<script>
  function submitForm() {
    ...
    if (cardNumber && expirationDate && cvv && cardholderName && agreeCheckbox) {
      ...
      //window.location.href = 'http://localhost:8080/demo2_war_exploded/bookingsuccess.jsp';
    } else {
